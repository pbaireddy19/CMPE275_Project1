...
/*	public StorageConf getStorage() {
	...
	public static final class GeneralConf {
		...
		public int getNodeId()
		{
			return Integer.parseInt(general.get("node.id"));
		}
		
		
		public int getPort()
		{
			return Integer.parseInt(general.get("port"));
		}
		
		public int getMgmtPort()
		{
			return Integer.parseInt(general.get("port.mgmt"));
		}
		
		public int getVotes()
		{
			return Integer.parseInt(general.get("node.votes"));
		}
	 ...
	 * 
	 * @XmlAccessorType(XmlAccessType.FIELD) public static final class
	 * StorageConf { private String tenant = TenantNoOpStorage.class.getName();
	 * private String voting = VotingNoOpStorage.class.getName(); private String
	 * election = ElectionNoOpStorage.class.getName();
	 * 
