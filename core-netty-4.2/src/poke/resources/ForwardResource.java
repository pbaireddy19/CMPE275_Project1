...
public class ForwardResource implements Resource {
	...
	private static ForwardResource fr= null;
	...
	public static ForwardResource getInstance()
	{
		if(fr==null)
		{
			fr=new ForwardResource();
		}
		return fr;
	...
	public Request process(Request request) {
		...
		if (nextNode != null) {
			System.out.println(" I have got a node to be forwarded...."+nextNode);
