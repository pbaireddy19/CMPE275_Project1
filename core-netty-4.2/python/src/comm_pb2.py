...
_IMAGEREQUEST_REQUESTTYPE = _descriptor.EnumDescriptor(
  name='RequestType',
  full_name='ImageRequest.RequestType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_IMAGEREQUEST_REQUESTTYPE)
...
_IMAGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='requesttype', full_name='ImageRequest.requesttype', index=0,
      number=1, type=14, cpp_type=8, label=2,
      has_default_value=False, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='contentlength', full_name='ImageRequest.contentlength', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ImageRequest.name', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='ImageRequest.data', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uuid', full_name='ImageRequest.uuid', index=4,
...
_IMAGERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='ImageResponse.uuid', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ImageResponse.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='ImageResponse.created', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='lastmodified', full_name='ImageResponse.lastmodified', index=3,
...
_IMAGEREQUEST.fields_by_name['requesttype'].enum_type = _IMAGEREQUEST_REQUESTTYPE
_IMAGEREQUEST_REQUESTTYPE.containing_type = _IMAGEREQUEST
